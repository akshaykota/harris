...
void sobelfilter(float *src[], float *dst[], int direction, CvMat *sobelimg);
...
sobelfilter(gaussian_image, sobel_image_x, SOBELX, sobelimgx);
sobelfilter(gaussian_image, sobel_image_y, SOBELY, sobelimgy);
