...
sobelfilter(&gaussian_image[0][0], &sobel_image[0][0], input_image->height, input_image->width, SOBELX, sobelimgx);
sobelfilter(&gaussian_image[0][0], &sobel_image[0][0], input_image->height, input_image->width, SOBELY, sobelimgy);
